...
# root. As more documents are added under spec/ (e.g. spec/some-report/), each
# becomes a subpath of the site automatically. Nothing else in the repository
# is published — meeting minutes and other non-spec documents stay on GitHub
# only.
#
